...
; Route 20
	db 60, TENTACRUEL, BLASTOISE, DEWGONG, 0
...
; Route 19
	db 59, TENTACRUEL, CLOYSTER, 0
	db 59, SEADRA, SEADRA, STARMIE, 0
	db 60, POLIWRATH, RAICHU, 0
	db 57, SEADRA, DRAGONAIR, TENTACRUEL, SEAKING, 0
	db 59, SEAKING, CLOYSTER, GYARADOS, 0
	db 60, SEADRA, GOLDUCK, 0
	db 57, JYNX, RAICHU, STARMIE, SEADRA, TENTACRUEL, 0
; Route 20
	db 61, STARMIE, CLOYSTER, 0
	db 65, STARMIE, 0
	db 58, SEADRA, VENUSAUR, SEADRA, VAPOREON, 0
; Route 21
...
; Route 20
	db 65, SEAKING, 0
	db 60, BLASTOISE, GOLDUCK, CLOYSTER, 0
	db 61, POLIWRATH, SEAKING, 0
; Route 15
...
; Route 19
	db 57, CLOYSTER, GOLDUCK, SEAKING, LAPRAS, POLIWRATH, 0
	db 60, SEAKING, LAPRAS, 0
	db 59, SEAKING, PINSIR, STARMIE, 0
; Route 20
	db 60, SEADRA, STARMIE, VICTREEBEL, 0
