...
; Rocket Hideout B1F
	db 37, DROWZEE, MACHOP, 0
	db 37, RATICATE, RATICATE, 0
	db 36, GRIMER, KOFFING, KOFFING, 0
	db 35, KADABRA, RATICATE, NINETALES, FEAROW, 0
	db 36, RAICHU, KOFFING, 0
	
; Rocket Hideout B2F
	db 33, PARASECT, KOFFING, DODRIO, GOLBAT, RATICATE, 0
; Rocket Hideout B3F
	db 36, DODUO, RATICATE, HYPNO, 0
	db 37, MACHOKE, PRIMEAPE, 0
; Rocket Hideout B4F
	db 38, PERSIAN, ARBOK, SANDSLASH, 0
	db 38, MACHOKE, SANDSHREW, ARBOK, 0
	db 36, RAICHU, GOLBAT, 0
; Pokémon Tower 7F
...
ErikaData:
	db $FF, 32, VICTREEBEL, 30, TANGELA, 32, VILEPLUME, 31, CLOYSTER, 34, EXEGGUTOR, 0
