...
; Cinnabar Gym
	db 61, CHARIZARD, GOLEM, NINETALES, 0
	db 61, RAPIDASH, CHARIZARD, JOLTEON, ARCANINE, 0
	db 64, RAPIDASH, 0
	db 62, ARCANINE, FLAREON, 0
...
; Cinnabar Gym
	db 61, RHYDON, FLAREON, FLAREON, 0
	db 63, RAPIDASH, 0
	db 60, CHARIZARD, ARCANINE, 0
; Mansion 2F
	db 59, MUK, CHARIZARD, 0
; Mansion 3F
	db 62, NINETALES, 0
; Mansion B1F
	db 59, ARCANINE, RHYDON, 0
...
; Route 21
	db 60, SEAKING, DEWGONG, SEAKING, JYNX, 0
	db 61, STARMIE, CLOYSTER, 0
	db 64, MAGIKARP, MAGIKARP, MAGIKARP, MAGIKARP, DRAGONAIR, GYARADOS, 0
	db 63, SEAKING, POLIWRATH, 0
; Route 12
...
; Route 21
	db 63, SEADRA, TENTACRUEL, 0
	db 67, STARMIE, 0
	db 63, GOLDUCK, BLASTOISE, 0
	db 62, POLIWRATH, TENTACRUEL, SEADRA, 0
...
; Route 21
	db 61, GYARADOS, CLOYSTER, TENTACRUEL, 0
...
; Viridian Gym
	db 63, DUGTRIO, MACHAMP, 0
	db 64, MACHAMP, 0
	db 63, MACHAMP, PRIMEAPE, POLIWRATH, 0
; Victory Road 2F
...
; Mansion 3F
	db 59, WEEZING, MAGNETON, LAPRAS, 0
; Mansion B1F
	db 60, MAGNETON, GOLEM, 0
...
; Viridian Gym
	db $FF, 65, DUGTRIO, 64, NIDOQUEEN, 64, PERSIAN, 64, NIDOKING, 65, TAUROS, 68, RHYDON, 0
...
BlaineData:
	db $FF, 63, MAGMAR, 65, NINETALES, 67, RHYDON, 64, RAPIDASH, 65, EXEGGUTOR, 68, ARCANINE, 0
