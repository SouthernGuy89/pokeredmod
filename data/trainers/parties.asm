...
; Route 8
	db 32, NIDORINA, POLIWHIRL, 0
	db 32, DODUO, MEOWTH, PERSIAN, 0
	db 30, PIDGEOTTO, HORSEA, NIDORINO, MAGNEMITE, GROWLITHE, 0
	db 33, CLEFAIRY, WIGGLYTUFF, 0
; Celadon Gym
...
; Route 8
	db 31, VOLTORB, KOFFING, TENTACOOL, PORYGON, 0
	db 30, GRIMER, MUK, MAGNETON, 0
	db 33, KOFFING, 0
; Unused
...
; Route 8
	db 31, STARYU, SEEL, POLIWHIRL, 0
; Unused
	db 22, ONIX, GEODUDE, GRAVELER, 0
; Route 8
	db 32, CHARMELEON, VULPIX, 0
